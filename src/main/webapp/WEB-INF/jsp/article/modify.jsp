			...
			<tr>
				...
				<td>
					<div class="form-control-box">
						...
						<div class="img-box">
							<img alt="image not supported" src="/usr/file/showImg?id=${article.extra.file__common__attachment['3'].id}&updateDate=${article.extra.file__common__attachment['3'].updateDate}">
						</div>
					</c:if>
				</td>
			</tr>
